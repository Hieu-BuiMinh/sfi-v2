import CustomerTaxComplianceDeclarationPageView from '@/views/portal_sfi/customer/pages/my-applications.page/pages/application-detail.page/pages/tax-compliance-declaration.page'
